...
To evaluate how well a candidate’s skills match the job description, we use [Sentence-BERT (`all-MiniLM-L6-v2`)](https://www.sbert.net/), a **pre-trained sentence embedding model**.
...
![Image](https://github.com/user-attachments/assets/fdbbe1d1-9b9a-4f0b-a50b-6e07bb79f3d4)
